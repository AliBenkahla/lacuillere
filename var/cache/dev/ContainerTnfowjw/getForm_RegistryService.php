...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\commentType' => function () {
    ...
    return ${($_ = isset($this->services['AppBundle\Form\photoType']) ? $this->services['AppBundle\Form\photoType'] : $this->services['AppBundle\Form\photoType'] = new \AppBundle\Form\photoType()) && false ?: '_'};
}, 'AppBundle\\Form\\restaurantType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\restaurantType']) ? $this->services['AppBundle\Form\restaurantType'] : $this->services['AppBundle\Form\restaurantType'] = new \AppBundle\Form\restaurantType()) && false ?: '_'};
